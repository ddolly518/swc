...
public class Frag2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Button gamebt6 = view.findViewById(R.id.gamebt6);
        gamebt6.setOnClickListener(v -> {
        ...
        Button gamebt7 = view.findViewById(R.id.gamebt7);
        gamebt7.setOnClickListener(v -> {
        ...
        Button healthbt1 = view.findViewById(R.id.healthbt1);
        healthbt1.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://youtu.be/wP5rGmrTyjg"));
            startActivity(intent);
        });

        Button videobt1 = view.findViewById(R.id.videobt1);
        videobt1.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=enD8zJRw8J0"));
            startActivity(intent);
        });

        Button videobt2 = view.findViewById(R.id.videobt2);
        videobt2.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=pL_O4uWj0eg"));
            startActivity(intent);
        });

        Button videobt3 = view.findViewById(R.id.videobt3);
        videobt3.setOnClickListener(v -> {
